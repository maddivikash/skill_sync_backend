...
from app.api.routes import user, goal, path, step, task, dashboard, catalog, chat, learn, prep, notifications, posts, blog
...
app = FastAPI(title="Ascend API", lifespan=lifespan)
